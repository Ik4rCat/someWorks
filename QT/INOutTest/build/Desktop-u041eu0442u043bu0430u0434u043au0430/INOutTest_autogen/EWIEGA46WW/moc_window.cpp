...
template <> constexpr inline auto Window::qt_create_metaobjectdata<qt_meta_tag_ZN6WindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "Window",
        "on_numplusone_clicked",
        "",
        "on_nummunusone_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_numplusone_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_nummunusone_clicked'
...
void Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_numplusone_clicked(); break;
        case 1: _t->on_nummunusone_clicked(); break;
        default: ;
        }
    }
    (void)_a;
