...
void counter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->counterChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->slotInc(); break;
        case 3: _t->slotMnc(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (counter::*)()>(_a, &counter::goodbye, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (counter::*)(int )>(_a, &counter::counterChanged, 1))
            return;
    }
}
